...
7. **Create the PR**: `gh pr create ...` with task-specific title/body, add labels (`task-2`, `service-rust-basic-api-2`, `run-play-workflow-template-v97g8`), and capture test results (reuse the narrative above in the PR body).
