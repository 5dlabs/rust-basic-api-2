...
7. **Create the PR**: `gh pr create ...` with task-specific title/body, add labels (`task-1`, `service-rust-basic-api-2`, `run-play-workflow-template-s2w62`), and capture test results (reuse the narrative above in the PR body).
